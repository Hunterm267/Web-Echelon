...
define("DBL_USERNAME", "b3-echelon"); // username that can connect to that DB
define("DBL_PASSWORD", "ghostdev123"); // Password for that user
define("DBL_DB", "b3-echelon"); // Password for that user
...
define("SALT", 'xhX6FmNiB8EzYuo7'); // do not change ever, this is salt for hashes
